...
VCS_CXXFILES = $(SIM_CXXFILES) $(DIFFTEST_CXXFILES) $(GEN_CXXFILES) $(ARTI_CXXFILES) $(PLUGIN_DASM_CXXFILES) 
VCS_CXXFILES += $(shell find $(VCS_CSRC_DIR) -name "*.cpp")

VCS_CXXFLAGS += -std=c++11 -static -Wall -I$(CFG_DIR) -I$(GEN_CSRC_DIR) -I$(ARTI_CSRC_DIR) -I$(VCS_CSRC_DIR) -I$(SIM_CSRC_DIR)
