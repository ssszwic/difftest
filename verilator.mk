...
EMU_CXXFLAGS += -I$(SIM_CSRC_DIR) -I$(GEN_CSRC_DIR) -I$(ARTI_CSRC_DIR) -I$(PLUGIN_INC_DIR)
...
EMU_CXXFILES += $(ARTI_CSRC_DIR)/chisel_db.cpp
EMU_CXXFLAGS += -I$(ARTI_CSRC_DIR) -DENABLE_CHISEL_DB
